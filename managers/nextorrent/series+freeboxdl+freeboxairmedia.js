 ...
 */
function NextorrentSeriesFreebox(sarahContext) {
...
util.inherits(NextorrentSeriesFreebox, Manager);
 ...
 */
NextorrentSeriesFreebox.initialize = function(initCtx) {
	...
	FreeboxDownloader.ee.once('done', function(appInfo) {
		if(appInfo) {
			...
			FreeboxAirMedia.ee.once('done', NextorrentSeriesFreebox.ee.emit.bind(NextorrentSeriesFreebox.ee, 'done'));
		}
	});
}

NextorrentSeriesFreebox.ee = new EventEmitter();
 ...
 */
NextorrentSeriesFreebox.detect = function(detectCtx) {
	new FreeboxDetector().detect().on('available', NextorrentSeriesFreebox.ee.emit.bind(NextorrentSeriesFreebox.ee, 'available'));
}


module.exports = NextorrentSeriesFreebox;
