...
function VuzeDownloader(sarahContext, matcher, vuzePath) {
	this.sarahContext = sarahContext;
	this.matcher = matcher;
	this.vuzePath = vuzePath || sarahContext.directory+'lib/downloader/vuze/';
	this.downloading = [];
...
VuzeDownloader.initialize = function(initCtx) {
	// start vuze in console mode and wait for commands
	vuze = spawn('C:/Program Files/Java/jre7/bin/java.exe', ['-classpath', 'D:/SARAH/plugins/magicdl/lib/downloader/vuze/', '-jar', 'D:/SARAH/plugins/magicdl/lib/downloader/vuze/Azureus2.jar', '--ui=console']);
...
VuzeDownloader.prototype.start = function(item) {
