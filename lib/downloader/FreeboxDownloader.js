 ...
 * @param matcher				a matcher that will associate items currently in download with the items to download (there is no simple way to associate items as the name of the file found on a website differs from the name of the file currently downloading)
