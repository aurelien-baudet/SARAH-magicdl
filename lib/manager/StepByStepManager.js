 ...
 */
function StepByStepManager(/*Object*/sarahContext, /*Searcher*/searcher, /*Filter*/filter, /*NameProvider*/nameProvider, /*UrlProvider*/urlProvider, /*Downloader*/downloader, /*Player*/player, /*Notifiers{}*/notifiers) {
...
StepByStepManager.prototype.register = function() {
	...
	this.notifiers.downloaded.on('done', this.play.bind(this));
}
